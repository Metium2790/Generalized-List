...
namespace Generalized_List
{
    ...
    public class GList //generalized list
    {
        ...
        public Node FindNode(int n) //A function to find a node inside the list
        {
            Node p = first;
            int temp = n;
            ...
            if (p != null)
            {
                ...
                if (p != null)
                {
                    if (p.flag == true)
                    {
                        Console.WriteLine("The node you chose already has down link. do you want to add down link to one of its nodes ?(No=-1)(Yes=enter the number)");
                        int number = Int32.Parse(Console.ReadLine());
                        if (number == -1)
                        {
                            return p;
                        }
                        return p.dlink.FindNode(number);
                    }
                    else
                    {
                        return p;
                ...
                {
                    Console.WriteLine("You reached out of the list");
                    return null;
                }
            }
            else
